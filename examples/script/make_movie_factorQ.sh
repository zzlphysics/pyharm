...
# FILE_PATH="/home/zzl/kx-4t/kharma/output/20241112_cuda_kerr_sane_a09375_256-128-8_10-20"



# Run pyharm-analysis
pyharm-analysis basic,dynamo,factorQ,factorQ_mass_weighted "$FILE_PATH" --nthreads=6 -f factorQ.h5
